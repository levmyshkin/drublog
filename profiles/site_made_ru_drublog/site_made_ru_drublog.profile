...
function site_made_ru_drublog_install_tasks($install_state){
  ...
  $tasks['change_language'] = array(
	...
	'function' => 'site_made_ru_drublog_change_default_language',
  );
  $tasks['post_install_1'] = array(
	...
	'type' => 'batch',
	'run' => INSTALL_TASK_RUN_IF_NOT_COMPLETED,
	'function' => 'site_made_ru_drublog_post_install_1',
  );  
  return $tasks;
}
...
$query = db_insert('node_revision')
  ...
  $query = db_insert('field_data_body')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'page',
      'deleted' => 0,
  ...
  $query = db_insert('field_data_field_image')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'blog',
      'deleted' => 0,
  ...
  $query = db_insert('field_data_field_photos')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'photoalbum',
      'deleted' => 0,
  ...
  $query = db_insert('field_data_field_tags')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'blog',
      'deleted' => 0,
  ...
  $query = db_insert('field_data_meta_description')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'blog',
      'deleted' => 0,
  ...
  $query = db_insert('field_data_meta_keywords')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'blog',
      'deleted' => 0,
  ...
  $query = db_insert('field_revision_body')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'page',
      'deleted' => 0,
  ...
  $query = db_insert('field_revision_field_image')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'blog',
      'deleted' => 0,
  ...
  $query = db_insert('field_revision_field_tags')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'blog',
      'deleted' => 0,
  ...
  $query = db_insert('metatags_quick_path_based')
    ->fields(array(
	  'id' => 1,
	  'path' => 'blog',
	  'lang' => 'ru',
  ...
  $query = db_insert('node_comment_statistics')
    ->fields(array(
      'nid' => 1,
      'cid' => 0,
  ...
  $query = db_insert('field_revision_field_photos')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'photoalbum',
      'deleted' => 0,
  ...
  $query = db_insert('field_revision_meta_description')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'blog',
      'deleted' => 0,
  ...
  $query = db_insert('field_revision_meta_keywords')
    ->fields(array(
      'entity_type' => 'node',
      'bundle' => 'blog',
      'deleted' => 0,
...
function site_made_ru_drublog_install_tasks_alter(&$tasks, $install_state){
